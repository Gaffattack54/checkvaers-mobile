...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-brand-cyan text-white shadow-sm hover:bg-brand-cyan-600 active:bg-brand-cyan-600",
        secondary:
          "bg-brand-navy text-white hover:bg-brand-navy-700 active:bg-brand-navy-700",
        outline:
          "border border-input bg-background text-foreground hover:bg-accent",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        link: "text-brand-cyan underline-offset-4 hover:underline rounded-none",
      },
      size: {
        default: "h-12 px-6 py-2 min-h-tap",
        sm: "h-10 px-4",
